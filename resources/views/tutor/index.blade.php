                    ...
                    <div style="background-color:#94C21C" class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <table>
                            <tr style="text-align: left;color:#000000">
                                ...
                                <th width="40px"><a href="{{ route('tutor.create') }}"><img src="{{ asset('images/adicionar.png') }}" style="width:20px;height:20px;" alt="Adicionar"></a></th>
                                <th width="40px">&nbsp;</th>
                            </tr>
                            ...
                            @foreach($tutores as $tutor)
                                <tr style="text-align: left;">
                                    ...
                                    <td><form action="{{ route('tutor.edit', $tutor->id)}}" method="GET"><button type="submit">Editar</button></form></td>
                                    <td><form action="{{ route('tutor.destroy', $tutor->id) }}" method="POST">@csrf @method('DELETE')<button type="submit">Excluir</button></form></td>
                                </tr>
                            @endforeach
