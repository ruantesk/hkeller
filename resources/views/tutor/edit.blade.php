                ...
                <div style="background-color:#5e7c12" class="p-6 text-gray-600 dark:text-gray-100">
                    ...
                    <form method="post" action="{{ route('tutor.update', $tutor->id) }}" class="">
                        ...
                        <div>
                            ...
                            <x-text-input id="nome" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm mt-1 block w-full" type="text" name="nome" :value="$tutor->nome" required autofocus />
