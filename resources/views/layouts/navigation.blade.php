<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700" style="background-color:#769b16">
    ...
    <div style="background-color:#769b16" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
