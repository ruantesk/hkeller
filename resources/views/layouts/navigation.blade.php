<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700" style="background-color:#94C21C">
    ...
    <div style="background-color:#94C21C" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
